...
public class Region {
    ...
    // indicate if a given point falls inside or outside of a region's area
    ...
    // divide a range into four equal quadrants and return a specified one
